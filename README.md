...
![Agent Memory Explorer](frontend/public/screenshots/SCR-20260609-pret.png)
...
1. **The Backend (Demiurgic Engine)**
   ...
   - **Cognition (`cognition_service.py`)**: Formulates LLM prompts by injecting terrain context, episodic memory, theological beliefs, and recent working memory. It then parses the LLM decisions back into the physics engine.
...
**A:** Yes! The user acts as the "Demiurge." You can pause the simulation, inspect individual agents, view their complex memory graphs, and manually trigger global events (like Famines or resource injections) to see how the societies adapt to catastrophic changes.
...
**A:** The physics engine uses a set of fundamental rules (stamina costs, crop maturity, damage modifiers) but allows for emergent complexity through LLM actions. A long-term goal is a fully autonomous "bottom-up" loop where collective agent beliefs compile into actual physics laws.

---

## 📸 Gallery

| Grid Visualization | Social Dynamics |
|:---:|:---:|
| ![Grid Overview](frontend/public/screenshots/SCR-20260609-prhk.png) | ![Civilization Activity](frontend/public/screenshots/SCR-20260609-okvs.png) |
| Detailed map showing structures, resources, and civilizations claiming territory. | Inspecting agent logs, beliefs, and interactions in real-time. |

| Inspector View | Action Logging |
|:---:|:---:|
| ![Agent Stats](frontend/public/screenshots/SCR-20260609-prly.png) | ![Event Log](frontend/public/screenshots/SCR-20260609-pssf.png) |
| A deep dive into an individual agent's history and current needs. | A breakdown of world events and simulated consequences. |

*(All screenshots belong to Project Doxa)*
